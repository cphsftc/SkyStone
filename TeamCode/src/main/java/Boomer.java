...
public class Boomer extends OpMode {
    ...
    private double x, x2, y, y2, power, power2, liftPower, hardWareSucksPower;//Instantiating the vars that will be used for the power and direction of the DcMotors
    private DcMotor frontRight, frontLeft, backRight, backLeft, elevator, hardwareSucks;//Instantiating the DcMotors for the
    ...
    public void init() {
        ...
        hardwareSucks = hardwareMap.dcMotor.get("HARDWARESUCKS");//0 - hub1

        //Setting the x and y vars to the default value of 0.0
        x = 0.0;
        y = 0.0;
        liftPower = 0;
        hardWareSucksPower = 0;
    ...
    public void loop() {
        ...
        liftPower = 0;
        if(gamepad1.left_bumper) liftPower = 1;
        if(gamepad1.right_bumper) liftPower = -1;
        ...
        hardWareSucksPower = 0;
        hardWareSucksPower += gamepad1.right_trigger;
        hardWareSucksPower -= gamepad1.left_trigger;

        hardwareSucks.setPower(hardWareSucksPower);
